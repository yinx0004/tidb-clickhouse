...
get_partitions = "SELECT partition FROM system.parts WHERE database = %(db)s AND table = %(table)s"
get_partition_key = "SELECT partition_key from system.tables WHERE database= %(db)s AND table = %(table)s"